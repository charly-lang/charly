...
module Charly::Internals
  ...
  charly_api "sleep", TNumeric do |amount|
    sleep amount.value / 1000
    return TNull.new
  end

  #  Evaluate a string
  charly_api "eval", TString, TObject do |source, environment|
